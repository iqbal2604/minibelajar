...
func IsPublished(v bool) predicate.Blog {
	return predicate.Blog(sql.FieldEQ(FieldIsPublished, v))
}

// PublishSchedule applies equality check predicate on the "publish_schedule" field. It's identical to PublishScheduleEQ.
func PublishSchedule(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldEQ(FieldPublishSchedule, v))
}
...
func IsPublishedEQ(v bool) predicate.Blog {
	return predicate.Blog(sql.FieldEQ(FieldIsPublished, v))
}

// IsPublishedNEQ applies the NEQ predicate on the "is_published" field.
func IsPublishedNEQ(v bool) predicate.Blog {
	return predicate.Blog(sql.FieldNEQ(FieldIsPublished, v))
}

// PublishScheduleEQ applies the EQ predicate on the "publish_schedule" field.
func PublishScheduleEQ(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldEQ(FieldPublishSchedule, v))
}

// PublishScheduleNEQ applies the NEQ predicate on the "publish_schedule" field.
func PublishScheduleNEQ(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldNEQ(FieldPublishSchedule, v))
}

// PublishScheduleIn applies the In predicate on the "publish_schedule" field.
func PublishScheduleIn(vs ...time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldIn(FieldPublishSchedule, vs...))
}

// PublishScheduleNotIn applies the NotIn predicate on the "publish_schedule" field.
func PublishScheduleNotIn(vs ...time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldNotIn(FieldPublishSchedule, vs...))
}

// PublishScheduleGT applies the GT predicate on the "publish_schedule" field.
func PublishScheduleGT(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldGT(FieldPublishSchedule, v))
}

// PublishScheduleGTE applies the GTE predicate on the "publish_schedule" field.
func PublishScheduleGTE(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldGTE(FieldPublishSchedule, v))
}

// PublishScheduleLT applies the LT predicate on the "publish_schedule" field.
func PublishScheduleLT(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldLT(FieldPublishSchedule, v))
}

// PublishScheduleLTE applies the LTE predicate on the "publish_schedule" field.
func PublishScheduleLTE(v time.Time) predicate.Blog {
	return predicate.Blog(sql.FieldLTE(FieldPublishSchedule, v))
}

// PublishScheduleIsNil applies the IsNil predicate on the "publish_schedule" field.
func PublishScheduleIsNil() predicate.Blog {
	return predicate.Blog(sql.FieldIsNull(FieldPublishSchedule))
}

// PublishScheduleNotNil applies the NotNil predicate on the "publish_schedule" field.
func PublishScheduleNotNil() predicate.Blog {
	return predicate.Blog(sql.FieldNotNull(FieldPublishSchedule))
}
