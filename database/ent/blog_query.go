...
func (_q *BlogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BlogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *BlogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *BlogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *BlogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *BlogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
